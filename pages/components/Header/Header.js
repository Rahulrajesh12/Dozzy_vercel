    ...
    <div className='font-bold text-lg px-5 md:px-12 lg:px-20 py-4 flex justify-between items-center'>
      ...
      <div>
        <div className='py-2 text-black'>
          ...
          <Link onClick={(e) => LinkCall(e, "tel:9666655973")} className='lg:text-3xl lg:pt-2 pt-1 font-bold text-sm flex items-center gap-1 lg:gap-2' href="tel:9666655973" target='_blank'>
